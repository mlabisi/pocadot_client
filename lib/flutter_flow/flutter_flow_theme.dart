...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color greyscale200 = Color(0xFFEEEEEE);
  late Color pink = Color(0xFFEA1E61);
  late Color blue = Color(0xFF1D9BF0);
  late Color boldRed = Color(0xFFEE2E24);
