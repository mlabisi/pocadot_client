...
class SelectedIdolCardWidget extends StatefulWidget {
  const SelectedIdolCardWidget({Key? key}) : super(key: key);

  @override
  _SelectedIdolCardWidgetState createState() => _SelectedIdolCardWidgetState();
}
